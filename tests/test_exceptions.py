...
def test_fastapi_integration_various_details(status: int, detail: str | dict) -> None:
    app = air.Air()
...
def test_custom_exception_handler_compat() -> None:
    ...
    async def custom_http_exception_handler(_: air.Request, exc: FastAPIHTTPException):
