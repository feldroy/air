...
def test_stock_tags_comprehensive_coverage() -> None:
    ...
    tags_with_children = [
        ...
        air.Article("Article content", id_="main-article"),
        ...
        # Headers
        air.H1("Header 1", id_="title", class_="main-title"),
        air.H2("Header 2", class_="sub-title"),
        air.H3("Header 3", style="color: blue"),
        air.H4("Header 4", id_="section"),
        ...
        air.Li("List item", class_="item", id_="item1"),
        ...
        # Table elements
        air.Table("Table content", class_="table", id_="table1"),
        air.Tbody("Table body", class_="tbody"),
        air.Td("Table cell", colspan=2, rowspan=1, class_="cell"),
        air.Template("Template content", id_="template1", class_="template"),
