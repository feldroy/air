...
if __name__ == "__main__":
    ...
    if False:
        console.print(repr(SMALL_AIR_TAG_SAMPLE))
    # Print a full representation of the tag.
    if False:
        console.print(SMALL_AIR_TAG_SAMPLE.full_repr())
    # Print the rendered HTML representation of the tag.
    if False:
        console.print(SMALL_AIR_TAG_SAMPLE.render())
    # Print the rendered HTML representation of the tag.
    if False:
        console.print(str(SMALL_AIR_TAG_SAMPLE))
    # Print the prettified-formatted rendered HTML representation of the tag.
    if False:
        console.print(SMALL_AIR_TAG_SAMPLE.pretty_render())
    # Print the compact-formatted rendered HTML representation of the tag.
    if False:
        console.print(SMALL_AIR_TAG_SAMPLE.compact_render())
    ...
    if False:
        ...
        console.print(f"{compact_size=}, {regular_size=}, {pretty_size=}")
    ...
    if False:
        console.print(SMALL_AIR_TAG_SAMPLE.to_pretty_dict())
    # Serialize the tag to a dict.
    if False:
        console.print(SMALL_AIR_TAG_SAMPLE.to_dict())
    # Serialize the tag to a JSON string.
    if False:
        console.print(SMALL_AIR_TAG_SAMPLE.to_json())
    # Serialize the tag to a prettified JSON string.
    if False:
        console.print(SMALL_AIR_TAG_SAMPLE.to_pretty_json())
    # Reconstruct a tag from a serialized dict.
    if False:
        console.print(repr(SMALL_AIR_TAG_SAMPLE.from_dict(SMALL_AIR_TAG_SAMPLE.to_dict())))
    # Reconstruct a tag from a serialized JSON string.
    if False:
        console.print(repr(SMALL_AIR_TAG_SAMPLE.from_json(SMALL_AIR_TAG_SAMPLE.to_json())))
    # Convert this air-tag into the instantiable-formatted representation of the tag.
    if False:
        console.print(SMALL_AIR_TAG_SAMPLE.to_source())
    ...
    if False:
        console.print(air.Tag.from_html_to_source(SMALL_HTML_SAMPLE))
