...
def filter_tags(
    ...
    """
    Filter endpoint with list query parameters.
    """
...
def advanced_search(
    ...
    """
    Advanced search with multiple query parameter types.
    """
...
def index() -> Children | Html:
    """
    Home page with links demonstrating query parameter generation.
    """
    ...
    return air.layouts.mvpcss(
        ...
        air.Ul(
            air.Li(air.A("Page 1", href=search.url(query_params={"q": "air", "page": 1}))),  # ty: ignore[unresolved-attribute]
            air.Li(air.A("Page 2", href=search.url(query_params={"q": "air", "page": 2}))),  # ty: ignore[unresolved-attribute]
            air.Li(air.A("Page 3", href=search.url(query_params={"q": "air", "page": 3}))),  # ty: ignore[unresolved-attribute]
        ),
        ...
        air.Ul(
            air.Li(
                air.A(
                    "Python & JavaScript",
                    href=filter_tags.url(query_params={"tags": ["python", "javascript"]}),  # ty: ignore[unresolved-attribute]
                )
            ),
            air.Li(
                air.A(
                    "Web & API",
                    href=filter_tags.url(query_params={"tags": ["web", "api"]}),  # ty: ignore[unresolved-attribute]
                )
            ),
            air.Li(air.A("Single Tag", href=filter_tags.url(query_params={"tags": ["htmx"]}))),  # ty: ignore[unresolved-attribute]
        ),
        air.H2("Combined Parameters"),
        air.P(
            air.A(
                "Search 'framework' on page 2 with tags",
                href=advanced_search.url(  # ty: ignore[unresolved-attribute]
                    query_params={
                        "q": "framework",
                        "page": 2,
                        "tags": ["python", "web"],
