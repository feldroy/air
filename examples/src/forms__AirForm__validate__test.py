...
def test_validate_with_invalid_data() -> None:
    """Test validate method with invalid form data"""
    client = TestClient(app)
...
def test_validate_with_empty_data() -> None:
    """Test validate method with empty form data"""
    client = TestClient(app)
